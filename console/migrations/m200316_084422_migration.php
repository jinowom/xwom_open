...
class m200316_084422_migration extends Migration
{
    public function up()
    {
...
/* Table admin */
$this->batchInsert('{{%admin}}',['user_id','username','real_name','password_hash','password_reset_hash','email','email_verify_token','phone','auth_key','access_token','role','role_id','status','created_at','updated_at','dep_isleader','team_leader'],[['100007','admin_test','admin_test','$2y$13$4jBON5wv8gsitmaNhMCXIu0nrUzXnzHuqYhl8/HiVF71OcI9H80qa',null,'1234@qq.com',null,'18310888888','','','1','admin','10','1584170050','1584170050','0','0'],
...
$this->batchInsert('{{%auth_assignment}}',['item_name','user_id','created_at'],[['admin','100007','1584170050'],
