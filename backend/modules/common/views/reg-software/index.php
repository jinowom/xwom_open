           ...
           // ],
                ...
                'header' => '<div class="layui-table-cell">操作</div>',
                                    ...
                                    'buttons' => [
                                            ...
                                            'update' => function ($url, $model, $key) {
                                                ...
                                                //$url = Yii::$app->urlManager->createUrl(['reg-software/view', 'id' => $model->id, 'edit' => 't']);
            ...
            'toolbar' => [
                ['content' =>
                    ...
                    ['role' => "modal-remote", 'title' => Yii::t('app','Create new').Yii::t('app','Reg Softwares'), 'class' => "btn btn-default"]).
