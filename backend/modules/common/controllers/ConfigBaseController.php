...
class ConfigBaseController extends BaseController
{
    public function actions()
    {
        return [
            'editable-edit' => [
                ...
                'modelClass' => ConfigBaseSearch::class,                // the model for the record being edited
                'scenario' => ConfigBaseSearch::SCENARIO_EDITABLE,
            ...
            'toggle' => [
                ...
                'modelClass' => ConfigBase::class, // Your model class
            ],
        ];
    }
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            if($request->isGet){
                return [
                    'title' => Yii::t('app','Create new').Yii::t('app','ConfigBase'),
                ...
                return [
                    ...
                    'title' => Yii::t('app','Create new').Yii::t('app','ConfigBase'),
                    'content' => '<span class="text-success">Create ConfigBase success</span>',
                    'footer' => Html::button(Yii::t('app', 'Close'), ['class' => 'btn btn-default pull-left','data-dismiss' => "modal"]).
