                    ...
                    <div class="layui-card-body ztree">
                        ...
                        <script>
                                    ...
                                    for(var i=0;i<length;i++){
                                        ...
                                        zNodes.push({teamid:auth[i].teamid,father_id:auth[i].father_id,name:''+ auth[i].name+'',true_name:''+ auth[i].true_name+'',checked:checked});
                                    }
                                    ...
                                    $(document).ready(function(){
                                        ...
                                        $('body').on('click','#setting',function(){
                                            ...
                                            Cajax({
                                                type:"POST",
                                                url:'<?php  echo \yii\helpers\Url::toRoute(['team/team-auth']);    ?>',
