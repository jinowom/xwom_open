...
/* @var $searchModel common\models\reg\RegWidgetsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Reg Widgets');
           ...
           // ],
                ...
                'header' => '<div class="layui-table-cell">操作</div>',
                                    ...
                                    'buttons' => [
                                            ...
                                            'update' => function ($url, $model, $key) {
                                                ...
                                                //$url = Yii::$app->urlManager->createUrl(['reg-widgets/view', 'id' => $model->id, 'edit' => 't']);
            ...
            'toolbar' => [
                ['content' =>
                    ...
                    ['role' => "modal-remote", 'title' => Yii::t('app','Create new').Yii::t('app','Reg Widgets'), 'class' => "btn btn-default"]).
