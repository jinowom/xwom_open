...
/* @var $model backend\modules\xpaper\models\XpCommentSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="xp-comment-search">
    ...
    <?php // echo $form->field($model, 'newstitle') ?>

    <?php // echo $form->field($model, 'discuss_content') ?>

    <?php // echo $form->field($model, 'discuss_ip') ?>

    <?php // echo $form->field($model, 'discuss_time') ?>
