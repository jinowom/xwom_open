<?php
/**
 * This is the model class for table "ConfigConstant";
...
/**
 * This is the model class for table "{{%config_constant}}".
 *
 * @property int $id ID
 ...
 */
class ConfigConstant extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * {@inheritdoc}
     * @return ConfigConstantQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new ConfigConstantQuery(get_called_class());
    }
