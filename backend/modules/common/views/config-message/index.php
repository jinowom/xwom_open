...
layui.use(['table','form'], function(){
    ...
    ,cols : [[
        ...
        {field: 'body', title: '消息内容', width: '', align:'center'},            
        {field:'is_send_all', title:'是否发给所有人', templet:function(d){
            if(d.is_send_all == 1){
                return '否'
            }else{
                return '是'
        ...
        {field: 'listorder', title: '排序', width: '', align:'center'},                       
