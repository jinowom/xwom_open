...
/* @var $searchModel backend\modules\xpaper\models\XpSensitiveWordSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */
$this->title = Yii::t('app', 'Xp Sensitive Words');
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            ?>
                            <?//= Html::a(Yii::t('app', '<i class= layui-icon></i>添加 Xp Sensitive Word'), ['create'], ['class' => 'layui-btn layui-default-add']) ?>
                        </div>
                                        ...
                                        'delete'=>function($url,$model,$key)
                                            {
                                                ...
                                                if($model->status == 0){//不同的视图，需要修改这里字段名称
