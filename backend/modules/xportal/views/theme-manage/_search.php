...
/* @var $model backend\modules\xportal\models\XportalThemeSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="xportal-theme-search">
    ...
    <?php // echo $form->field($model, 'big_type_id') ?>

    <?php // echo $form->field($model, 'theme_name') ?>
    ...
    <?php // echo $form->field($model, 'index_theme') ?>
