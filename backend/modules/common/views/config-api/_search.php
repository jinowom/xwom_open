...
/* @var $model common\models\config\ConfigApiSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="config-api-search">
    ...
    <?php // echo $form->field($model, 'encryption_mode') ?>

    <?php // echo $form->field($model, 'encryption_algorithm') ?>

    <?php // echo $form->field($model, 'is_sign') ?>
