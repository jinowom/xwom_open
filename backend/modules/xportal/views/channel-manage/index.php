...
/* @var $searchModel backend\modules\xportal\models\XportalChannelSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */
$this->title = Yii::t('app', 'Xportal Channels');
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            ?>
                            <!--<?= Html::a(Yii::t('app', '<i class= layui-icon></i>添加 Xportal Channel'), ['create'], ['class' => 'layui-btn layui-default-add']) ?> -->                        </div>
