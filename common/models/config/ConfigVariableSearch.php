<?php
/**
 * Class name is ConfigVariableSearch * @package backend\modules\common\controllers;
...
/**
 * ConfigVariableSearch represents the model behind the search form of `common\models\config\ConfigVariable`.
 */
class ConfigVariableSearch extends ConfigVariable
{
    /**
     * {@inheritdoc}
     */
