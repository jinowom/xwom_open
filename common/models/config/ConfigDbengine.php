<?php
/**
 * This is the model class for table "ConfigDbengine";
...
/**
 * This is the model class for table "{{%config_dbengine}}".
 *
 * @property int $id ID
 * @property string $name 引擎名
 ...
 */
class ConfigDbengine extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['status', 'created_at', 'updated_at', 'created_id', 'updated_id'], 'integer'],
    ...
    */
    ...
    /**
     * {@inheritdoc}
     * @return ConfigDbengineQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new ConfigDbengineQuery(get_called_class());
    }
