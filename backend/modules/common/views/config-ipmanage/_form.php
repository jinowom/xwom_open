...
<div class="config-ipmanage-form create_box">
    ...
    <?= $form->field($model, 'start_time')->textInput()->textInput(['class'=>'layui-input']) ?>

    <?= $form->field($model, 'end_time')->textInput()->textInput(['class'=>'layui-input']) ?>
