...
/* @var $searchModel backend\modules\xportal\models\XportalNewsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */
$this->title = Yii::t('app', 'Xportal News');
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            ?>
                            <!--<?= Html::a(Yii::t('app', '<i class= layui-icon></i>添加 Xportal News'), ['create'], ['class' => 'layui-btn layui-default-add']) ?> -->                        </div>
