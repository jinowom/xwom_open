<?php
/**
 * Class name is ConfigDbengineSearch * @package backend\modules\common\controllers;
...
/**
 * ConfigDbengineSearch represents the model behind the search form of `common\models\config\ConfigDbengine`.
 */
class ConfigDbengineSearch extends ConfigDbengine
{
    /**
     * {@inheritdoc}
     */
