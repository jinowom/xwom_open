<?php
/**
 * Class name is RegModuleSearch * @package backend\modules\common\controllers;
...
/**
 * RegModuleSearch represents the model behind the search form about `common\models\reg\RegModule`.
 */
class RegModuleSearch extends RegModule
{
