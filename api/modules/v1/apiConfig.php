...
//        'user.get'=>['class'=>'jinowom\demo\v1\user\Get','auth'=>true],      
//        'user.signup'=> api\modules\v1\controllers\UserController::class,
//        'user.login'=> api\modules\v1\controllers\UserController::class,
//        'user.sendsms'=> api\modules\v1\controllers\UserController::class,
//        'user.forgotpassword'=> api\modules\v1\controllers\UserController::class,
//        'user.feedback'=> api\modules\v1\controllers\UserController::class,
//        'user.nicknameupdate'=> api\modules\v1\controllers\UserController::class,
