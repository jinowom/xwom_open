...
use jinowom\aliyun\Core\Auth\Credential;
use jinowom\aliyun\Core\Auth\ShaHmac1Signer;
use jinowom\aliyun\Core\Regions\ProductDomain;
use jinowom\aliyun\Core\Regions\Endpoint;
use jinowom\aliyun\Core\Regions\EndpointProvider;
