...
namespace backend\components\gii\layui_gii\src\api;
...
{
    public $showName = 'LayuiAPI CRUD Generator';
    public $modelClass = 'app\models\XX';
    public $controllerClass = 'app\modules\api\controllers\XXXController';
