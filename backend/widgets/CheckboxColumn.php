...
class CheckboxColumn extends Column
{
    ...
    protected function renderHeaderCellContent()
    {
        ...
        return Html::checkbox($this->getHeaderCheckBoxName(), false, ['class' => 'select-on-check-all',"lay-filter"=>"allChoose","id"=>"allChoose","lay-skin"=>"primary"]);
    }
