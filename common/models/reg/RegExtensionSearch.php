<?php
/**
 * Class name is RegExtensionSearch * @package backend\modules\common\controllers;
...
/**
 * RegExtensionSearch represents the model behind the search form about `common\models\reg\RegExtension`.
 */
class RegExtensionSearch extends RegExtension
{
    ...
    public function rules()
    {
        return [
            ...
            [['title', 'name', 'title_initial', 'bootstrap', 'service', 'cover', 'brief_introduction', 'description', 'author', 'version', 'is_setting', 'is_rule', 'is_merchant_route_map', 'default_config', 'console', 'status'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $this->filterLike($query, 'is_merchant_route_map');
