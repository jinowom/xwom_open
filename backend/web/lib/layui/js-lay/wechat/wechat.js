        ...
        render:function(ele){
            ...
            table.render({
                ...
                cols: [[
                    ...
                    {field: 'name',align:'center', title: '公众号名称', minWidth:80, sort: false, },
                    {field: 'type',align:'center', title: '类型', minWidth:150, sort: false},
                    {field: 'logo',align:'center', title: '公众号LOGO',minWidth: 150, sort: false,templet:'<div style="height: 80px; "><img src="{{ d.logo }}" width="80px"></div>'},
                    {field: 'qrcode',align:'center', title: '二维码', minWidth:100, sort: false,templet:'<div style="height: 80px; "><img src="{{ d.qrcode }}" width="80px"></div>'},
                    {field: 'status',align:'center', title: '状态', minWidth:100,sort: false},
                    {field: 'valid_status',align:'center', title: '接入状态', minWidth:100,sort: false},
                    {fixed: 'right',align:'center', title:'操作', toolbar: '#tdTool', width:350}
                ]],done: function () {
        ...
        barTable:function(ele){
            ...
            table.on('toolbar('+ele+')',function(obj) {
                ...
                switch (obj.event) {
                    case 'add':
                        //添加
                        xadmin.open('添加公众号',addUrl,'','',true,false);
                        break;
                    case 'refresh':
                        _this.render(ele);
                        //执行重载
