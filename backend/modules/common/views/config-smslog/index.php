...
/* @var $searchModel common\models\log\ConfigSmslogSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */
$this->title = Yii::t('app', 'Config Smslogs');
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            ?>
                            <!--<?= Html::a(Yii::t('app', '<i class= layui-icon></i>添加 Config Smslog'), ['create'], ['class' => 'layui-btn layui-default-add']) ?> -->                        </div>
