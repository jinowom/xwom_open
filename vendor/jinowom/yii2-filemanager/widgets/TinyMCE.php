<?php
namespace jinowom\filemanager\widgets;

use Yii;
use yii\widgets\InputWidget;
use yii\web\JsExpression;
use jinowom\filemanager\assets\FileInputAsset;
use jinowom\tinymce\TinyMce as TinyMceWidget;
use yii\helpers\Url;
...
class TinyMce extends InputWidget
{
    ...
    public function run()
    {
        ...
        $modal = $this->renderFile('@vendor/jinowom/yii2-filemanager/views/file/modal.php', [
