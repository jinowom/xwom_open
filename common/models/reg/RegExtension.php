...
/**
 * This is the model class for table "{{%reg_extension}}".
 *
 * @property int $id 主键ID
 * @property string $title 中文名
 * @property string $name 扩展名或标识
 ...
 */
class RegExtension extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * {@inheritdoc}
     * @return RegExtensionQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new RegExtensionQuery(get_called_class());
    }
