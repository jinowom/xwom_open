...
<div class="config-functionlog-index">
           ...
           // ],
                ...
                'header' => '<div class="layui-table-cell">操作</div>',
                                    ...
                                    'buttons' => [
                                            ...
                                            'update' => function ($url, $model, $key) {
                                                ...
                                                //$url = Yii::$app->urlManager->createUrl(['config-functionlog/view', 'id' => $model->id, 'edit' => 't']);
            ...
            'toolbar' => [
                ['content' =>
                    ...
                    ['role' => "modal-remote", 'title' => Yii::t('app','Create new').Yii::t('app','Config Functionlogs'), 'class' => "btn btn-default"]).
