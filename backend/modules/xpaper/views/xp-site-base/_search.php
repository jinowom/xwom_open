...
/* @var $model backend\modules\xpaper\models\XpSiteBaseSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="xp-site-base-search">
    ...
    <?php // echo $form->field($model, 'ftp_folder') ?>

    <?php // echo $form->field($model, 'auto_folder') ?>
    ...
    <?php // echo $form->field($model, 'site_open') ?>
    ...
    <?php // echo $form->field($model, 'ismempower') ?>
